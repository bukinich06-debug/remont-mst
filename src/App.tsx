      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-100 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            {NAV_LINKS.map(l => (
              <a key={l.href} href={l.href} className="text-sm font-600 text-slate-600 hover:text-[#1d6fc4] transition-colors">
                {l.label}
              </a>
            ))}
          </nav>

          <a href="tel:+375291234567" className="hidden md:flex items-center gap-2 bg-[#1d6fc4] text-white px-4 py-2 rounded-xl text-sm font-700 hover:bg-[#1659a0] transition-colors">
        ...
        {menuOpen && (
          <div className="md:hidden bg-white border-t border-slate-100 px-4 py-4 flex flex-col gap-3">
            {NAV_LINKS.map(l => (
              <a key={l.href} href={l.href} className="text-sm font-600 text-slate-700 py-1" onClick={() => setMenuOpen(false)}>
                {l.label}
              </a>
            ))}
            <a href="tel:+375291234567" className="mt-2 flex items-center justify-center gap-2 bg-[#1d6fc4] text-white py-2.5 rounded-xl text-sm font-700">
              📞 +375 (29) 123-45-67
            </a>
          </div>
        )}
        ...
        <div className="relative max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-10">
              <a href="tel:+375291234567" className="flex items-center justify-center gap-2 bg-[#1d6fc4] text-white px-6 py-3.5 rounded-xl font-700 text-base hover:bg-[#1659a0] transition-all shadow-lg shadow-blue-200">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.53 2 2 0 0 1 3.59 1.36h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.91a16 16 0 0 0 6.18 6.18l.92-.92a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>
                </svg>
                Позвонить мастеру
              </a>
              <a href="#contact" className="flex items-center justify-center gap-2 bg-white border border-slate-200 text-slate-700 px-6 py-3.5 rounded-xl font-700 text-base hover:border-[#1d6fc4] hover:text-[#1d6fc4] transition-all">
                Оставить заявку
              </a>
            </div>
      ...
      <section className="py-8 bg-white border-y border-slate-100">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-2">
            {BRANDS.map(b => (
              <span key={b} className="text-slate-400 font-700 text-sm hover:text-[#1d6fc4] transition-colors cursor-default">{b}</span>
            ))}
          </div>
        </div>
      </section>
      ...
      <section id="services" className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {SERVICES.map(s => (
              <div key={s.title} className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  {s.items.map(item => (
                    <li key={item} className="flex items-center gap-2.5 text-sm text-slate-600 font-500">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        ...
                        <path d="M5 8l2 2 4-4" stroke={s.accent} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                      {item}
                    </li>
                  ))}
                </ul>
                <a href="#contact" className="mt-6 inline-flex items-center gap-1.5 text-sm font-700 text-[#1d6fc4] hover:gap-3 transition-all">
                  Вызвать мастера
      ...
      <section id="why" className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {ADVANTAGES.map(a => (
              <div key={a.title} className="group p-6 rounded-2xl border border-slate-100 hover:border-blue-200 hover:bg-blue-50/30 transition-all cursor-default">
      ...
      <section className="py-16 px-4 bg-[#1d6fc4]">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="tel:+375291234567" className="inline-flex items-center justify-center gap-2 bg-white text-[#1d6fc4] px-7 py-3.5 rounded-xl font-800 text-base hover:bg-blue-50 transition-colors shadow-lg">
              📞 +375 (29) 123-45-67
            </a>
            <a href="https://t.me/masterservice_mstsislaw" className="inline-flex items-center justify-center gap-2 bg-blue-500/30 border border-white/30 text-white px-7 py-3.5 rounded-xl font-700 text-base hover:bg-blue-500/50 transition-colors">
              ...
              {[
                {
                  icon: '📞',
                  title: 'Телефон',
                  lines: ['+375 (29) 123-45-67', '+375 (44) 765-43-21'],
                ...
                <div key={item.title} className="flex gap-4 p-5 bg-white rounded-2xl border border-slate-100 shadow-sm">
                  ...
                  <div className="flex-1">
                    ...
                    {item.lines.map(l => <div key={l} className="text-sm text-slate-500 font-500">{l}</div>)}
                    {item.link && (
                      <a href={item.link} className="mt-2 inline-flex items-center gap-1 text-xs font-700 text-[#1d6fc4] hover:underline">
                        {item.linkText} →
                      </a>
                    )}
                  </div>
